...
export const LabeledTableTitle = ({ name }: TableTitle): ReactElement => <span color='primary'>{name}</span>
  ...
  return (
    <Toolbar className={classes.toolbar}>
      ...
      <div className={classes.tableTitle}>
        {' '}
        <LabeledTableTitle name={name} variant='center' />
      </div>
